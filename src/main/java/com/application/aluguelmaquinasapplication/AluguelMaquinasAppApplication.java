...
public class AluguelMaquinasAppApplication {
    ...
    private final AvaliacaoMaquinaRepository avaliacaoMaquinaRepository;

    public AluguelMaquinasAppApplication(AluguelRepository aluguelRepository,
        ...
        this.avaliacaoMaquinaRepository = avaliacaoMaquinaRepository;
    }
